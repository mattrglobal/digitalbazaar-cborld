...
export class Transformer {
   ...
   *   of the undefined terms will be preserved during compression.
   */
  constructor({appContextMap, documentLoader, allowUndefinedTerms} = {}) {
    this.appContextMap = appContextMap;
    this.documentLoader = documentLoader;
    this.allowUndefinedTerms = allowUndefinedTerms;
  }
  ...
  async _updateContextStack({contextStack, contexts, transformer}) {
    ...
    for(const context of contexts) {
      ...
      if(!entry) {
        ...
        // support parsing context lists recursively
