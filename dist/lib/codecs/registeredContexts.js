...
exports.URL_TO_ID = exports.ID_TO_URL = void 0;
/*!
 * Copyright (c) 2021 Digital Bazaar, Inc. All rights reserved.
 */
// known CBOR-LD registry values
exports.ID_TO_URL = new Map();
exports.URL_TO_ID = new Map();
/**
...
function _addRegistration(id, url) {
    exports.URL_TO_ID.set(url, id);
    exports.ID_TO_URL.set(id, url);
}
//# sourceMappingURL=registeredContexts.js.map